...
public class MiniFeedforward
{
    public final double ks;
    public final double kv;
    public final double ka;
    public double ps=0,pv=0,pa=0;
     ...
     */
    public MiniFeedforward(double ks, double kv, double ka)
    {
        this.ks = ks;
        this.kv = kv;
        this.ka = ka;
     ...
     * @param kv The velocity gain.
     */
    public MiniFeedforward(double ks, double kv)
    {
        this(ks, kv, 0);
    }
    ...
    public double calculate(double velocity, double acceleration)
    {
        ...
        ps = ks * Math.signum(velocity);
        pv = kv * velocity;
        pa = ka * acceleration;
        if(Math.signum(velocity) != Math.signum(acceleration)) {
            //ps /= 2.0;
        }
        return ps + pv + pa;
    }
