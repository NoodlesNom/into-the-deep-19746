...
import static org.firstinspires.ftc.teamcode.autonomous.gf.GFMovement.profileStates.gunningIt;
...
public class GFMovement
{
    ...
    private static double movement_x = 0;
    private static double movement_y = 0;
    private static double movement_turn = 0;

    private static double worldXPosition = 0;
    private static double worldYPosition = 0;
    public static double worldAngle_rad = 0;

    private static double xVel = 0;
    private static double yVel = 0;
    private static double radVel = 0;
    ...
    public static double getMovement_x()
    {
        return movement_x;
    }

    public static double getMovement_y()
    {
        return movement_y;
    }

    public static double getMovement_rad()
    {
    ...
    public static void setVoltageComp(double v)
    {
        voltage = v;
    }
    ...
    public static movementResult gunToPosition(double targetX, double targetY, double point_angle,
        ...
        double velocityAdjustedRelativePointAngle = AngleWrap(relativePointAngle -
                (Constants.turnSlipAmountFor1RPS * radVel));
    ...
    public static movementResult pointAngle(double point_angle, double point_speed, double decelerationRadians) {
        ...
        double velocityAdjustedRelativePointAngle = AngleWrap(relativePointAngle - (Constants.turnSlipAmountFor1RPS * radVel));
    ...
    public static CurvePoint getFollowPointPath(ArrayList<CurvePoint> pathPoints,
        ...
        for(int i = 0; i < pathPoints.size()-1; i ++){
            ...
            ArrayList<Point> intersections =
                    GFMath.lineCircleIntersection(xPos,yPos,followRadius,
