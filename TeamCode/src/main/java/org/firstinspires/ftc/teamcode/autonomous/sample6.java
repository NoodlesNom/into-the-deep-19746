...
public class sample6 extends LinearOpMode {
        ...
        public class Pull implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                if (generaltimer.seconds()>1.9){
                    ...
                    if (block==0) {
                        robot.mIntake.setExtendoTicks((int) (((blockx1-4) * 25.4) / 1.25), timer.seconds());
                    }else{
                        robot.mIntake.setExtendoTicks((int) (((blockx2-4) * 25.4) / 1.25), timer.seconds());
                    }
    ...
    public void runOpMode() {
        ...
        Action sub1 = drive.actionBuilder(new Pose2d(7,19, Math.toRadians(83)))
                ...
                .splineTo(new Vector2d(47.5,60.5+ blocky1 -10), Math.toRadians(0),new TranslationalVelConstraint(55 ), new ProfileAccelConstraint(-45, 80))
        ...
        Action sub2 = drive.actionBuilder(new Pose2d(10,18, Math.toRadians(70)))
                ...
                .splineTo(new Vector2d(47.5,60.5+ blocky2 -10), Math.toRadians(0),new TranslationalVelConstraint(55 ), new ProfileAccelConstraint(-45, 80))
