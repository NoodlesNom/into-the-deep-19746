...
public class SpeedOmeter {
    ...
    public static void update(){
        ...
        if(currTime - lastUpdateStartTime > timeBetweenUpdates){
            ...
            angularVelocity = AngleWrap(RobotTesting.getAngle_rad()-lastAngle) / elapsedTime;
            lastAngle = getAngle_rad();
    ...
    public static double ySlipDistanceFor1CMPS = -0.407 * scalePrediction;//0.169;
