...
public class spec6_1 extends LinearOpMode {
    public Robot robot;
    ...
    public class robotController {
        ...
        public Action transfer() {
            return new robotController.Transfer();
        }
        ...
        public Action sample() {
            return new robotController.Sample();
        }
    ...
    public void runOpMode() {
        ...
        Action park = drive.actionBuilder(new Pose2d(-54.5,6, Math.toRadians(40)))
                ...
                .splineTo(new Vector2d(36, 8), Math.toRadians(0),new TranslationalVelConstraint(70 ), new ProfileAccelConstraint(-80, 90))
