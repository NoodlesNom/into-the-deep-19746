...
public class RobotPedro {

    public DriveManualMotor mDrive;
    ...
    // For Auto
    public RobotPedro(LinearOpMode opMode)
    {
        subsystems = new ArrayList<>();

        mDrive = new DriveManualMotor(opMode.hardwareMap);
...
//        }
    ...
    public RobotPedro(LinearOpMode opMode, Pose2d start, HardwareMap map)
    ...
    public RobotPedro(OpMode opMode, boolean addLift)
    {
        subsystems = new ArrayList<>();
...
//        }
    ...
    // For Teleop
    public RobotPedro(OpMode opMode)
    {
        this(opMode, true);
    }
