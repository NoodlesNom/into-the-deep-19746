...
public class GFRobot {
    ...
    // For Auto
    public GFRobot(LinearOpMode opMode)
    {
...
//        }
    ...
    public GFRobot(LinearOpMode opMode, Pose2d start, HardwareMap map)
    {
        subsystems = new ArrayList<>();
...
//        }
    ...
    public GFRobot(OpMode opMode, boolean addLift)
    {
        subsystems = new ArrayList<>();
...
//                }
                ...
                // See if we're below our thresh for info
                ...
                {
                    // If we're above thresh for long enough, report it
                ...
                // See if we're below our thresh for emergency
