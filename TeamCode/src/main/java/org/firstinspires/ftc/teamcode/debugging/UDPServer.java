...
public class UDPServer implements Runnable{
    ...
    private double lastSendMillis = 0;
    ...
    public void run()
    {
        while (true)
        {
            ...
            try {
                ...
                if (timer.milliseconds() - lastSendMillis < 1)
                {
                    continue;
                }
                // set the last send time
                lastSendMillis = timer.milliseconds();
    ...
    public void splitAndSend(String message)
    {
        ...
        do
        {
            ...
            sendUdpRAW(message.substring(startIndex, endIndex));
    ...
    private void sendUdpRAW(String message)
    {
        try (DatagramSocket serverSocket = new DatagramSocket())
        {
            ...
            //System.out.println("ATTEMPTED SEND :: " + message);
