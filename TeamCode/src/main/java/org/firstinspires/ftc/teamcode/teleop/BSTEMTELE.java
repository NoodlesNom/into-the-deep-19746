    ...
    public void loop()
    {
        ...
        switch (teleFSM){
            ...
            case INTAKING:{
                ...
                if (gamepad1.right_trigger>0.2&& robot.mIntake.getExtendoPosition()<520) {
            ...
            case SAMPLE:{
                ...
                if (samplesafe){
                    ...
                    if (robot.mLift.getLiftTicks()>730) {
                        robot.mDeposit.setPivotPos(Deposit.PIVOT_POS.SAMPLE.getVal(), 300, new double[] {2,3,3,3,3,3,3,2,1,1});
